...
$sql18=mysqli_query($conn,$query19);
$res18=mysqli_fetch_assoc($sql19);
...
<body><nav class="navbar navbar-expand-lg bg-light shadow-lg">
 ...
 <form action="update_products.php" enctype="multipart/form-data" method="POST">
  <div class="container">
  
     
      <label for="email"><b>Product Text</b></label>
       <input type="text" placeholder="Enter Banner Text" name="product_text13" id="" value="<?php echo $res13['value'];?>">

       <label for="psw"><b>Product Image</b></label>
       <input type="file" placeholder="" name="product_image12" id="" >

        <label for="psw"><b>Product Text</b></label>
       <input type="text" placeholder="" name="product_text15" id="" value="<?php echo $res15['value'];?>">

   
          <label for=""><b>Product Image</b></label>
        <input type="file" placeholder="Enter Inner Text" name="product_image14" id=""  >

         <label for=""><b>Product Text</b></label>
        <input type="text" placeholder="Enter Inner Text" name="product_text17" id=""  value="<?php echo $res17['value'];?>">

         <label for="psw"><b>Product Image</b></label>
       <input type="file" placeholder="" name="product_image16" id=""  >


            <label for=""><b>Product Text</b></label>
        <input type="text" placeholder="Enter Inner Text" name="product_text19" id=""  value="<?php echo $res19['value'];?>">

         <label for="psw"><b>Product Image</b></label>
       <input type="file" placeholder="" name="product_image18" id="" >
