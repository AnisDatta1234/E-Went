...
<body><nav class="navbar navbar-expand-lg bg-light shadow-lg">
 ...
 <form action="updateNews.php" enctype="multipart/form-data" method="POST">
  <div class="container">
      ...
      <label for="email"><b>News Image Left</b></label>
       <input type="file" placeholder="Enter Banner Text" name="news_image_left_22" id="" >
      
   
       <label for="email"><b>News Details</b></label>
       <input type="text" placeholder="Enter Banner Text" name="news_details_23" id="" value="<?php echo $res23['value'];?>">

       <label for="email"><b>News Image Right</b></label>
       <input type="file" placeholder="Enter Banner Text" name="news_image_right_24" id="" >

        <label for="email"><b>News Text</b></label>
       <input type="text" placeholder="" name="news_text_25" id="" value="<?php echo $res25['value'];?>">

        <label for="email"><b>News Image</b></label>
       <input type="file" placeholder="" name="news_image_right_26" id="" >

        <label for="email"><b>News Text</b></label>
       <input type="text" placeholder="" name="news_text_27" id="" value="<?php echo $res27['value'];?>">
